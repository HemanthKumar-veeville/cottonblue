module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        "display-h1": "var(--display-h1-font-family)",
        "display-h2": "var(--display-h2-font-family)",
        ...
        "label-smaller": "var(--label-smaller-font-family)",
        "label-smallest": "var(--label-smallest-font-family)",
        "text-bold-large": "var(--text-bold-large-font-family)",
        "text-bold-medium": "var(--text-bold-medium-font-family)",
        "text-bold-small": "var(--text-bold-small-font-family)",
        "text-bold-smaller": "var(--text-bold-smaller-font-family)",
        "text-bold-smallest": "var(--text-bold-smallest-font-family)",
        "text-large": "var(--text-large-font-family)",
        "text-medium": "var(--text-medium-font-family)",
        "text-small": "var(--text-small-font-family)",
        "text-smaller": "var(--text-smaller-font-family)",
        "text-smallest": "var(--text-smallest-font-family)",
        sans: [
          "ui-sans-serif",
          "system-ui",
          "sans-serif",
