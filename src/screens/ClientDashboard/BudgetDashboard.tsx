    ...
    <CardContent className="p-4 flex flex-col justify-center">
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center">
          <p className={`font-bold text-2xl ${textColor} font-montserrat`}>
    ...
    <Card className="p-4 shadow-shadow rounded-lg">
      <div className="flex flex-col gap-4 w-full">
        <div className="flex flex-col gap-1 w-full">
          <h2 className="font-bold text-lg text-[color:var(--1-tokens-color-modes-nav-tab-primary-default-text)] font-montserrat">
            {budgetData.title}
          </h2>
        </div>
